...
<style>
#slide-1 img{float:center;margin:auto; padding:8px;}
</style>

<center>
<img src="~/Documents/Writing Project/presentation/images/maphang.jpg" alt="fish" style="width: 800px;"/>
</center>


```{r, map, echo=FALSE, message=FALSE, eval=FALSE}
qmap("Seward, AK", zoom=4)+
...
<center>
<img src="~/Documents/Writing Project/presentation/images/logpage.png" alt="map" style="width: 900px;"/>
</center>

---

<center>
<img src="~/Documents/Writing Project/presentation/images/statchart.png" alt="map" style="width: 850px;"/>
</center>
...
<center>
<img src="~/Documents/Writing Project/presentation/images/twodmap.png" alt="map" style="width: 750px;"/>
</center>
...
```{r, twodmap, echo=FALSE, eval=FALSE, message=FALSE, fig.height = 12, fig.width=24}
require(ggmap)
seward <- get_map(location =c(-148.9999, 59.70589), zoom=8, maptype="terrain", 
                  filename="~/Documents/Writing Project/seward")
map.file <- read.csv("~/Documents/Writing Project/report/datafiles/mapfile.csv")
...
ggmap(seward, extent = 'normal') + 
  geom_path(aes(x = lon, y = lat, group=area, size=intervals), data = map.file)+
  geom_polygon(aes(fill=area, group=area), data=map.file)+
  scale_fill_manual(values=getPalette(colourCount))+
  labs(size="proportion of use")+
...
<center>
<img src="~/Documents/Writing Project/presentation/images/twodmapindareas.png" alt="map" style="width: 750px;"/>
</center>
...
ind.census <- read.csv("~/Documents/Writing Project/report/datafiles/census.csv")
...
<center>
<img src="~/Documents/Writing Project/presentation/images/jacksparrow.jpg" alt="jack" style="width: 300px;float:right; padding: 10px; padding-top:initial"/>
</center>

<ul style="list-style-type:circle">
<li>Two days a week randomly selected for interviews </li>
<li>Effort spread across the four harbor cleaning stations </li>
<li>Boat selection is pseudo-random</li>
...
indicator <- read.csv("~/Documents/Writing Project/report/datafiles/indicator.csv")
...
ggplot(data=res.int, aes(YEAR, Proportion))+
  geom_line(aes(YEAR, Proportion), colour="darkred", linetype="dotted")+
  ...
  geom_line(aes(YEAR, truth), colour="midnightblue", linetype="dotted")
...
require(dplyr)
compare <- read.csv("~/Documents/Writing Project/report/datafiles/compare.csv")
...
ggplot(data=cleare.int, aes(YEAR, Proportion))+
  geom_line(aes(YEAR, Proportion), colour="darkred", size=2, linetype="dashed")+
  geom_point(aes(YEAR, Proportion), colour="darkred", size=5)+
  stat_smooth(colour="darkred", level=0.95, data=cleare.int[12:21,], size=2)+
  stat_smooth(aes(YEAR, truth), alpha=0.6, level=0.95, colour="midnightblue",
              size=2)+
  geom_point(aes(YEAR, truth), colour="midnightblue", size=5)+
  geom_line(aes(YEAR, truth), colour="midnightblue", size=2, linetype="dashed")+
...
<center>
<img src="~/Documents/Writing Project/presentation/images/biomap.png" alt="map" style="width: 750px;"/>
</center>
...
```{r, el, echo=FALSE, fig.width=14, fig.height=9}
#Cape Cleare
