...
avg.loglengths <- na.omit(fish.stat[,7:10]) %>%
  group_by(year, statarea, area) %>%
  summarise(mean.in=mean(log(length.in))) %>%
  ungroup()

lm.el.ols <- lm(mean.in~year, data=subset(avg.loglengths, area=="elrington"))
lm.cleare.ols <- lm(mean.in~year, data=subset(avg.loglengths, area=="capecleare"))

lm.junken.ols <- lm(mean.in~year, data=subset(avg.loglengths, area=="junken"))

lm.aialik.ols <- lm(mean.in~year, data=subset(avg.loglengths, area=="aialik"))

lm.resbay.ols <- lm(mean.in~year, data=subset(avg.loglengths, area=="resbay"))
```


```{r, wls, echo=FALSE, eval=FALSE}
...
lm.el.wls <- lm(mean.in~year, data=subset(avg.loglengths, area=="elrington"), weights=subset(weights, area=="elrington")$n)

lm.cleare.wls <- lm(mean.in~year, data=subset(avg.loglengths, area=="capecleare"), weights=subset(weights, area=="capecleare")$n)

lm.junken.wls <- lm(mean.in~year, data=subset(avg.loglengths, area=="junken"), weights=subset(weights, area=="junken")$n)

lm.aialik.wls <- lm(mean.in~year, data=subset(avg.loglengths, area=="aialik"), weights=subset(weights, area=="aialik")$n)

lm.resbay.wls <- lm(mean.in~year, data=subset(avg.loglengths, area=="resbay"), weights=subset(weights, area=="resbay")$n)
```
...
avg.loglengths <- arrange(avg.loglengths, area)
avg.loglengths$fit.me <- fit.me.vec
...
#aialik
a <- ggplot(subset(avg.loglengths, area=="aialik"), 
...
#capecleare
c <- ggplot(subset(avg.loglengths, area=="capecleare"), 
       aes(as.numeric(as.character(year)), fit.me))+
  geom_point(col="red", size=4)+
  geom_point(aes(as.numeric(as.character(year)), mean.in), size=4)+
  geom_line(aes(as.numeric(as.character(year)), mean.in), linetype="dotted")+
...
#elrington
e <- ggplot(subset(avg.loglengths, area=="elrington"), 
       aes(as.numeric(as.character(year)), fit.me))+
  geom_point(col="red", size=4)+
  geom_point(aes(as.numeric(as.character(year)), mean.in), size=4)+
  geom_line(aes(as.numeric(as.character(year)), mean.in), linetype="dotted")+
...
#junken
j <- ggplot(subset(avg.loglengths, area=="junken"), 
       aes(as.numeric(as.character(year)), fit.me))+
  geom_point(col="red", size=4)+
  geom_point(aes(as.numeric(as.character(year)), mean.in), size=4)+
  geom_line(aes(as.numeric(as.character(year)), mean.in), linetype="dotted")+
...
#resbay
r <- ggplot(subset(avg.loglengths, area=="resbay"), 
       aes(as.numeric(as.character(year)), fit.me))+
  geom_point(col="red", size=4)+
  geom_point(aes(as.numeric(as.character(year)), mean.in), size=4)+
  geom_line(aes(as.numeric(as.character(year)), mean.in), linetype="dotted")+
...
ggplot(results2, aes(area, incr))+
  ...
  geom_point(size=7, col="darkred")+
  ylab("Multiplicative Change in Fish Length 1994-2013")+
  theme(axis.text.y = element_text(size=20), axis.text.x=element_text(size=20),
        axis.title.y = element_text(size=20), axis.title.x=element_blank())
```
...
e <- ggplot(subset(avg.loglengths, area=="capecleare"), 
       aes(as.numeric(as.character(year)), fit.me))+
